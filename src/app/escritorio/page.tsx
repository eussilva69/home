...
export default function EscritorioPage() {
  ...
  useEffect(() => {
    const fetchAllProducts = async () => {
      ...
      // Idealmente, você filtraria por produtos específicos de "Escritório"
      // Como não temos essa categoria, vamos usar todos e embaralhar
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 pt-28">
        <div className="text-center mb-8">
            <h1 className="text-3xl md:text-5xl font-bold text-primary">Quadros para Escritório</h1>
            <p className="text-base md:text-lg text-muted-foreground mt-2 max-w-3xl mx-auto">Inspire produtividade e sofisticação no seu local de trabalho.</p>
        </div>

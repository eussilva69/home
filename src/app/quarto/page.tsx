...
export default function QuartoPage() {
  ...
  useEffect(() => {
    const fetchAllProducts = async () => {
      ...
      // Idealmente, você filtraria por produtos específicos de "Quarto"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 pt-28">
        <div className="text-center mb-8">
            <h1 className="text-3xl md:text-5xl font-bold text-primary">Quadros para Quarto</h1>
            <p className="text-base md:text-lg text-muted-foreground mt-2 max-w-3xl mx-auto">Crie um refúgio de tranquilidade e estilo pessoal.</p>
        </div>
